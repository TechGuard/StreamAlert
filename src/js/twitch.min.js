/**
 * Modified verion of Twitch SDK
 *
 * Changes:
 *   Storage uses chrome.sync
 *   Read error details when you add checkAuthentication option to init function
 */
...
(function() {
    ...
    var init = function(options, callback) {
        ...
        Twitch._config.checkAuthentication = options.checkAuthentication;
        Twitch._initSession(callback);
    };
...
(function() {
    ...
    var parseFragment = function() {
        ...
        var hash = document.location.hash || document.location.href;
    ...
    var initSession = function(callback) {
        ...
        if (window.JSON) {
            Twitch._storage.getItem(SESSION_KEY, function(storedSession){
                if (storedSession) {
                    try {
    ...
    var continueInit = function(callback) {
        ...
        if (Twitch._config.checkAuthentication || document.location.hash.match(/access_token=(\w+)/)) {
        ...
        getStatus({ force: !Twitch._config.checkAuthentication }, function(err, status) {
            if (typeof callback === 'function') {
                callback(err, status);
            }
